...
This tags used with `--advertise-tags` cli paramenter, when tailscale registers in tailnet.
Tags are required for OAuth clients managing devices (`tailscale_authkey` OAuth key).
